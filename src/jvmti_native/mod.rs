...
mod jvmti_native {
    ...
    pub type jsize = jint;
    #[repr(C)]
    pub struct Struct__jobject {
        pub _hacky_hack_workaround: u32,
    }
    ...
    pub struct JNINativeInterface {
        ...
        >,
        pub FindClass:
            Option<unsafe extern "C" fn(env: *mut JNIEnv, name: *const c_char) -> jclass>,
        pub FromReflectedMethod:
            Option<unsafe extern "C" fn(env: *mut JNIEnv, method: jobject) -> jmethodID>,
        pub FromReflectedField:
            Option<unsafe extern "C" fn(env: *mut JNIEnv, field: jobject) -> jfieldID>,
        ...
        pub IsAssignableFrom:
            Option<unsafe extern "C" fn(env: *mut JNIEnv, sub: jclass, sup: jclass) -> jboolean>,
        ...
        pub ThrowNew: Option<
            unsafe extern "C" fn(env: *mut JNIEnv, clazz: jclass, msg: *const c_char) -> jint,
        >,
        ...
        pub PopLocalFrame:
            Option<unsafe extern "C" fn(env: *mut JNIEnv, result: jobject) -> jobject>,
        ...
        pub EnsureLocalCapacity:
            Option<unsafe extern "C" fn(env: *mut JNIEnv, capacity: jint) -> jint>,
        ...
        pub IsInstanceOf:
            Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, clazz: jclass) -> jboolean>,
        ...
        >,
        pub GetIntField:
            Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject, fieldID: jfieldID) -> jint>,
        ...
        pub ReleaseStringChars:
            Option<unsafe extern "C" fn(env: *mut JNIEnv, str: jstring, chars: *const jchar) -> ()>,
        pub NewStringUTF:
            Option<unsafe extern "C" fn(env: *mut JNIEnv, utf: *const c_char) -> jstring>,
        pub GetStringUTFLength:
            Option<unsafe extern "C" fn(env: *mut JNIEnv, str: jstring) -> jsize>,
        ...
        >,
        pub ReleaseStringUTFChars: Option<
            unsafe extern "C" fn(env: *mut JNIEnv, str: jstring, chars: *const c_char) -> (),
        >,
        ...
        >,
        pub NewBooleanArray:
            Option<unsafe extern "C" fn(env: *mut JNIEnv, len: jsize) -> jbooleanArray>,
        ...
        pub NewShortArray:
            Option<unsafe extern "C" fn(env: *mut JNIEnv, len: jsize) -> jshortArray>,
        ...
        pub NewFloatArray:
            Option<unsafe extern "C" fn(env: *mut JNIEnv, len: jsize) -> jfloatArray>,
        pub NewDoubleArray:
            Option<unsafe extern "C" fn(env: *mut JNIEnv, len: jsize) -> jdoubleArray>,
        ...
        pub UnregisterNatives:
            Option<unsafe extern "C" fn(env: *mut JNIEnv, clazz: jclass) -> jint>,
        ...
        >,
        pub ReleaseStringCritical: Option<
        ...
        pub GetDirectBufferAddress:
            Option<unsafe extern "C" fn(env: *mut JNIEnv, buf: jobject) -> *mut c_void>,
        pub GetDirectBufferCapacity:
            Option<unsafe extern "C" fn(env: *mut JNIEnv, buf: jobject) -> jlong>,
        pub GetObjectRefType:
            Option<unsafe extern "C" fn(env: *mut JNIEnv, obj: jobject) -> jobjectRefType>,
    }
    ...
    pub struct JNIInvokeInterface {
        ...
        pub GetEnv: Option<
            unsafe extern "C" fn(vm: *mut JavaVM, penv: *mut *mut c_void, version: jint) -> jint,
        >,
    ...
    extern "C" {
        ...
        pub fn JNI_GetCreatedJavaVMs(arg1: *mut *mut JavaVM, arg2: jsize, arg3: *mut jsize)
            -> jint;
        ...
        pub fn Agent_OnAttach(vm: *mut JavaVM, options: *mut c_char, reserved: *mut c_void)
            -> jint;
