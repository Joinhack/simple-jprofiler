...
use crate::jvmti::{
    JNIEnv, JVMTI_THREAD_NORM_PRIORITY
};
use crate::signal_prof::{SignalProf, SigactionFn};
use crate::{VM, get_vm_mut, log_info};
...
impl Profiler {
    ...
    pub fn start(&mut self, jni: JNIEnv) {
        ...
        jvmti.run_agent_thread(jthr, Some(VM::agent_profiler_run), ptr::null() as _, JVMTI_THREAD_NORM_PRIORITY as _);
